...
export const translations = {
  en: {
    ...
    // Register section
    registerTitle: 'Error Logger & Viewer',
    registerText: 'Start tracking errors and get insights for your project',
    registerFeatureRealtime: 'Real-time error tracking',
    registerFeatureTeam: 'Team & Solo projects',
    registerFeatureAnalytics: 'Advanced analytics',
    registerSubtitle: 'Sign Up',
    registerFormName: 'Your name',
    registerFormProject: 'Project name (optional)',
    registerFormEmail: 'Email',
    registerFormPassword: 'Password',
    registerButtonSignup: 'Sign Up',
    registerLinkGuest: 'Continue as Guest →',
    // aria labels
    registerTextAria: 'Registration introduction',
    registerFeatureRealtimeAria: 'Real-time error tracking',
    registerFeatureTeamAria: 'Team and solo projects',
    registerFeatureAnalyticsAria: 'Advanced analytics',
    registerSubtitleAria: 'Registration subtitle',
    registerFormNameAria: 'User name',
    registerFormProjectAria: 'Project name (optional)',
    registerFormEmailAria: 'Email address',
    registerFormPasswordAria: 'Password',
    registerControlsAria: 'Registration controls',
    registerButtonSignupAria: 'Sign up',
    registerLinkGuestAria: 'Continue as guest',
    // About
    navAbout: 'About',
  ...
  ru: {
    ...
    // Register section
    registerTitle: 'Error Logger & Viewer',
    registerText: 'Начните отслеживать ошибки и получать аналитику по проекту',
    registerFeatureRealtime: 'Отслеживание ошибок в реальном времени',
    registerFeatureTeam: 'Командные и одиночные проекты',
    registerFeatureAnalytics: 'Продвинутая аналитика',
    registerSubtitle: 'Регистрация',
    registerFormName: 'Ваше имя',
    registerFormProject: 'Название проекта (необязательно)',
    ...
    // aria labels
    registerTextAria: 'Введение в регистрацию',
    registerFeatureRealtimeAria: 'Отслеживание ошибок в реальном времени',
    registerFeatureTeamAria: 'Командные и одиночные проекты',
    registerFeatureAnalyticsAria: 'Продвинутая аналитика',
    registerSubtitleAria: 'Регистрация',
    registerFormNameAria: 'Ваше имя',
    registerFormProjectAria: 'Название проекта (необязательно)',
    registerFormEmailAria: 'Электронная почта',
    registerFormPasswordAria: 'Пароль',
    registerControlsAria: 'Элементы управления регистрацией',
    registerButtonSignupAria: 'Зарегистрироваться',
    registerLinkGuestAria: 'Продолжить как гость',
    // About
