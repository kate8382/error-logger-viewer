...
export class Aside {
  ...
  initControls() {
    ...
    const modeOptions = document.querySelectorAll(
      '.sidebar__dropdown-sublist[data-group="mode"] .sidebar__dropdown-option',
    );
      ...
      option.addEventListener('click', () => {
        ...
        if (window.app && window.app.errorApi && window.app.updateErrorTable) {
          ...
          if (
            ...
            typeof window.errorTableInstance.setMode === 'function'
          ) {
    ...
    const themeOptions = document.querySelectorAll(
      '.sidebar__dropdown-sublist[data-group="theme"] .sidebar__dropdown-option',
    );
    ...
    const langOptions = document.querySelectorAll(
      '.sidebar__dropdown-sublist[data-group="language"] .sidebar__dropdown-option',
    );
  ...
  initDropdowns() {
    ...
    const dropdownBtn = dropdown
      ? dropdown.querySelector('.sidebar__dropdown-btn')
      : null;
  ...
  translatePage() {
    const sidebarTexts = document.querySelectorAll(
      '.sidebar__item-text[data-i18n]',
    );
    ...
    const dropdownBtns = document.querySelectorAll(
      '.sidebar__dropdown-btn[data-i18n]',
    );
    ...
    const dropdownOptions = document.querySelectorAll(
      '.sidebar__dropdown-option[data-i18n]',
    );
    ...
    const groupTexts = document.querySelectorAll(
      '.sidebar__dropdown-group-text[data-i18n]',
    );
    ...
    const dropdownElements = document.querySelectorAll(
      '.sidebar__dropdown [data-i18n]:not(.sidebar__dropdown-btn):not(.sidebar__dropdown-option):not(.sidebar__dropdown-group-text)',
    );
    ...
    const otherElements = Array.from(
      ...
      (el) =>
        !el.classList.contains('sidebar__item-text') &&
        !el.closest('.sidebar__dropdown'),
    );
